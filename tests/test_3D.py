...
def test_patchi():
    ...
    c = patchi(100, 1050, 1000, 1750, t=3652.5, v=1, al=100, ah=20, av=20, 
...
def test_patchi_shape():
    ...
    c = patchi(100, x, y, 1750, t=3652.5, v=1, al=100, ah=20, av=20, 
       y1=900, y2=2100, z1=1350, z2=1650, lamb=lamb)
    
    assert c.shape == (len(x), len(y))   
    
    t = [1000, 2000, 3000]
    c = patchi(100, 1050, 1000, 1750, t=t, v=1, al=100, ah=20, av=20, 
       y1=900, y2=2100, z1=1350, z2=1650, lamb=lamb)
...
def test_patchf():
    ...
    c = patchf(c0=1000, x=1050, y=1000, z=50, t=3000, v=1, al=200, ah=60, av=10, w=3000, h=100, y1=400, y2=2000,
...
def test_patchf_shape():
    ...
    c = patchf(100, x, y, 1750, t=3652.5, v=1, al=100, ah=20, av=20,
               y1=900, y2=2100, z1=1350, z2=1650, w=4000, h=2000)
    
    assert c.shape == (len(x), len(y))   
    
    t = [1000, 2000, 3000]
    c = patchf(100, 1050, 1000, 1750, t=t, v=1, al=100, ah=20, av=20, 
